...
const promiseOrCallback = require('./helpers/promiseOrCallback'); // Ensure this import exists and is correct
...
Mongoose.prototype.connect = function(uri, options, callback) {
  ...
  return new Promise((resolve, reject) => {
    if (!uri || typeof uri !== 'string') {
      return reject(new Error('Invalid MongoDB URI provided. Please ensure the URI is a non-empty string.'));
    }
